...
interface ShowData {
  ...
  /** The airdate of the episode, in the format 'Month Day, Year'. */
  airdate: string;

  /** The airdate of the episode in short form, in the format 'YYYYMMDD'. */
  shortAirdate: string;
...
export type { ShowData, ShowChapterData, SegmentChapterData, MusicChapterData, AlternateData };
